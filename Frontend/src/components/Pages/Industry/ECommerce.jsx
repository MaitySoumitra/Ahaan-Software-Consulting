    ...
    <div className="container my-4 px-4 ">
      ...
      <div className="row mt-5 gap">
        <div className="col-md-5 p-4 col rounded custom-border">
          ...
          <p className="text-muted text ">
            Our platform provides a systematic order management process and an
            effective workflow, guaranteeing your business's smooth and
      ...
      <div className="row mt-5">
        <div className="col-md-6">
          <img
            src={simple}
            alt="Integration"
            className="img-fluid img-sec rounded"
          />
        </div>
        <div className="col-md-6">
          <h5 className="fw-bold mb-3">Simple Integration</h5>
          <p className="text-muted text">
            Ensure an easy and smart integration with your current systems to
            achieve an efficient and error-free process.
          </p>
          <p className="text-muted text">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
